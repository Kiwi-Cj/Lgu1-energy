...
// Support deployment layouts such as /path/current or /path/releases/<timestamp>
foreach (array_values(array_unique($candidatePaths)) as $dir) {
    ...
    // If a candidate is a public directory, its parent is commonly the Laravel base path.
