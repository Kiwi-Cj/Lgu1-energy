<footer class="footer" style="background:#22223b; color:#e0e7ef; padding:32px 0 18px 0; text-align:center; font-size:1rem; margin-top:48px;">
    <div class="container">
        <div class="mb-2">© <?php echo e(date('Y')); ?> Energy System Portal · All Rights Reserved</div>
...
<?php /**PATH C:\xampp\htdocs\energy-system\resources\views/partials/footer.blade.php ENDPATH**/ ?>