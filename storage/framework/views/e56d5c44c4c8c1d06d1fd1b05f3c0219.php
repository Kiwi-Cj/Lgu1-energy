        ...
        <div>
            ...
            <div class="settings-grid">
                <div class="settings-field">
                    ...
                    <input type="number" id="alert_low_small" name="alert_low_small" value="<?php echo e($settings['energy'][0]->low_small ?? 5); ?>" placeholder="Low %">
                </div>
                <div class="settings-field">
                    <label for="alert_medium_small">Medium %</label>
                    <input type="number" id="alert_medium_small" name="alert_medium_small" value="<?php echo e($settings['energy'][1]->medium_small ?? 10); ?>" placeholder="Medium %">
                </div>
                <div class="settings-field">
                    <label for="alert_high_small">High %</label>
                    <input type="number" id="alert_high_small" name="alert_high_small" value="<?php echo e($settings['energy'][2]->high_small ?? 20); ?>" placeholder="High %">
                </div>
            </div>
        </div>
        <div>
            ...
            <div class="settings-grid">
                <div class="settings-field">
                    ...
                    <input type="number" id="alert_low_medium" name="alert_low_medium" value="<?php echo e($settings['energy'][0]->low_medium ?? 7); ?>" placeholder="Low %">
                </div>
                <div class="settings-field">
                    <label for="alert_medium_medium">Medium %</label>
                    <input type="number" id="alert_medium_medium" name="alert_medium_medium" value="<?php echo e($settings['energy'][1]->medium_medium ?? 13); ?>" placeholder="Medium %">
                </div>
                <div class="settings-field">
                    <label for="alert_high_medium">High %</label>
                    <input type="number" id="alert_high_medium" name="alert_high_medium" value="<?php echo e($settings['energy'][2]->high_medium ?? 23); ?>" placeholder="High %">
                </div>
            </div>
        </div>
        <div>
            ...
            <div class="settings-grid">
                <div class="settings-field">
                    ...
                    <input type="number" id="alert_low_large" name="alert_low_large" value="<?php echo e($settings['energy'][0]->low_large ?? 10); ?>" placeholder="Low %">
                </div>
                <div class="settings-field">
                    <label for="alert_medium_large">Medium %</label>
                    <input type="number" id="alert_medium_large" name="alert_medium_large" value="<?php echo e($settings['energy'][1]->medium_large ?? 16); ?>" placeholder="Medium %">
                </div>
                <div class="settings-field">
                    <label for="alert_high_large">High %</label>
                    <input type="number" id="alert_high_large" name="alert_high_large" value="<?php echo e($settings['energy'][2]->high_large ?? 26); ?>" placeholder="High %">
                </div>
            </div>
        </div>
        <div>
            ...
            <div class="settings-grid">
                <div class="settings-field">
                    ...
                    <input type="number" id="alert_low_xlarge" name="alert_low_xlarge" value="<?php echo e($settings['energy'][0]->low_xlarge ?? 12); ?>" placeholder="Low %">
                </div>
                <div class="settings-field">
                    <label for="alert_medium_xlarge">Medium %</label>
                    <input type="number" id="alert_medium_xlarge" name="alert_medium_xlarge" value="<?php echo e($settings['energy'][1]->medium_xlarge ?? 18); ?>" placeholder="Medium %">
                </div>
                <div class="settings-field">
                    <label for="alert_high_xlarge">High %</label>
                    <input type="number" id="alert_high_xlarge" name="alert_high_xlarge" value="<?php echo e($settings['energy'][2]->high_xlarge ?? 28); ?>" placeholder="High %">
                </div>
            </div>
        </div>
        <div class="settings-grid">
