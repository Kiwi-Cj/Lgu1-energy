...
<div style="max-width:1100px;margin:0 auto;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:20px;margin-bottom:2rem;">
        ...
        <div style="background:#f5f8ff;padding:24px;border-radius:16px;box-shadow:0 4px 12px rgba(55,98,200,0.12);">
            ...
            <a href="<?php echo e(url('/modules/users/index')); ?>" style="display:inline-block;margin-top:10px;padding:8px 16px;background:#3762c8;color:#fff;border-radius:8px;font-weight:600;text-decoration:none;">Go</a>
        </div>
        ...
        <div style="background:#f0fdf4;padding:24px;border-radius:16px;box-shadow:0 4px 12px rgba(34,197,94,0.12);">
            ...
            <a href="<?php echo e(url('/modules/facilities/index')); ?>" style="display:inline-block;margin-top:10px;padding:8px 16px;background:#22c55e;color:#fff;border-radius:8px;font-weight:600;text-decoration:none;">Go</a>
        </div>
...
<?php echo $__env->make('layouts.qc-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lgu-energy\resources\views/modules/settings/index.blade.php ENDPATH**/ ?>