...
<body style="margin:0;padding:0;min-height:100vh;width:100vw;box-sizing:border-box;">
    <div style="min-height:100vh;width:100vw;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#f8fafc 0%,#e0e7ff 100%);font-family:'Inter',sans-serif;">
        <div style="width:100%;max-width:420px;padding:48px 36px 40px 36px;background:#fff;border-radius:22px;box-shadow:0 8px 32px rgba(37,99,235,0.10);display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;">
            ...
            <div style="font-size:2rem;font-weight:700;color:#1e293b;margin-bottom:10px;"><?php echo e(__('Page Expired')); ?></div>
            <!-- Removed default session expired message as requested -->
            <div style="font-size:1.15rem;color:#1e293b;margin-bottom:18px;font-weight:600;letter-spacing:0.01em;text-shadow:0 1px 8px #e0e7ff;"><?php echo e(__('You have been logged out because there was no activity or interaction for a period of time.')); ?></div>
            <a href="<?php echo e(url('/')); ?>" class="error-btn primary">Go to Home</a>
            <a href="<?php echo e(route('login')); ?>" class="error-btn secondary" style="margin-left:8px;">Login</a>
            <?php if(request()->is('logout')): ?>
...
<?php /**PATH C:\xampp\htdocs\energy-system\resources\views/errors/419.blade.php ENDPATH**/ ?>