    ...
    <div class="report-card-container">
        ...
        <div class="stats-grid" style="display:flex; gap:20px; flex-wrap:wrap; margin-bottom:2.5rem;">
            ...
            <div class="stat-card" style="background:#fff7ed;">
                ...
                <div style="font-size:2rem; font-weight:800; color:#9a3412;"><?php echo e($unresolvedIncidentCount ?? 0); ?></div>
            </div>
            ...
            <div class="stat-card" style="background:#f5f3ff;">
                ...
                <div style="font-size:2rem; font-weight:800; color:#4c1d95;"><?php echo e($ongoingMaintenance ?? 0); ?></div>
            </div>
        </div>
        ...
        <div class="summary-grid" style="display:grid; grid-template-columns: 1.5fr 1fr; gap:18px; margin-bottom:2rem;">
            <div class="summary-card" style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:14px; padding:16px;">
                ...
                <div style="display:flex; flex-wrap:wrap; gap:10px;">
                    <span style="background:#ecfdf5; color:#166534; border:1px solid #bbf7d0; padding:8px 12px; border-radius:999px; font-weight:700; font-size:0.82rem;">
                        Active: <?php echo e(optional($facilityStatusCounts)->active_count ?? 0); ?>
                    ...
                    <span style="background:#fffbeb; color:#92400e; border:1px solid #fde68a; padding:8px 12px; border-radius:999px; font-weight:700; font-size:0.82rem;">
                        Maintenance: <?php echo e(optional($facilityStatusCounts)->maintenance_count ?? 0); ?>
                    ...
                    <span style="background:#fef2f2; color:#991b1b; border:1px solid #fecaca; padding:8px 12px; border-radius:999px; font-weight:700; font-size:0.82rem;">
                        Inactive: <?php echo e(optional($facilityStatusCounts)->inactive_count ?? 0); ?>
            ...
            <div class="summary-card" style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:14px; padding:16px;">
                ...
                <div style="display:flex; flex-wrap:wrap; gap:8px;">
                    <a href="<?php echo e(route('modules.facilities.index')); ?>" class="quick-action-btn"><i class="fa-solid fa-building"></i> Facilities</a>
                    <a href="<?php echo e(route('energy.dashboard')); ?>" class="quick-action-btn"><i class="fa-solid fa-bolt"></i> Energy Monitoring</a>
                    <a href="<?php echo e(route('modules.energy.annual')); ?>" class="quick-action-btn"><i class="fa-solid fa-calendar-days"></i> Annual Monitoring</a>
                    <a href="<?php echo e(route('energy-incidents.index')); ?>" class="quick-action-btn"><i class="fa-solid fa-triangle-exclamation"></i> Incidents</a>
                </div>
            </div>
        </div>
        ...
        <div class="insights-grid">
                ...
                <div class="table-scroll" style="overflow-x:auto;">
                    <table class="custom-table consumption-table">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td class="facility-name"><?php echo e($facility->name); ?></td>
                                <td class="value-kwh" style="text-align:center;"><?php echo e(number_format($facility->total_kwh, 2)); ?></td>
                                <td class="value-baseline" style="text-align:center;"><?php echo e(number_format($facility->baseline_kwh, 2)); ?></td>
                                <td class="value-deviation" style="text-align:center; color:<?php echo e($deviationColor); ?>;"><?php echo e(number_format($deviation, 2)); ?>%</td>
                                <td style="text-align:center;">
                                    <span class="status-pill" style="background:<?php echo e($theme['bg']); ?>; color:<?php echo e($theme['text']); ?>; border-color:<?php echo e($theme['border']); ?>;">
                                        <?php echo e($status); ?>
            ...
            <div class="insight-card">
                ...
                <div class="notifications-body">
                    <?php $__empty_1 = true; $__currentLoopData = collect($criticalAlerts ?? [])->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        ?>
                        <div class="alert-item <?php echo e($levelClass); ?>">
                            <span class="alert-icon"><i class="fa-solid <?php echo e($iconClass); ?>"></i></span>
                            <span>
                                <strong class="alert-level"><?php echo e($level); ?></strong>
