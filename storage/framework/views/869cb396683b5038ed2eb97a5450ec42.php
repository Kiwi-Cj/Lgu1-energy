		...
		<table class="table" style="width:100%;background:#fff;border-radius:10px;overflow:hidden;text-align:center;">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php $facilityCount = $user->facilities ? $user->facilities->count() : 0; ?>
						<span style="font-weight:700;color:#6366f1;font-size:1.1em;"><?php echo e($facilityCount); ?></span>
					</td>
					<td>
	...
	<!-- USER MODAL -->
	   ...
	   <div class="modal-sheet" id="userModalSheet" aria-hidden="true">
		   <div class="modal-card user-edit-modal-pro" role="dialog" aria-modal="true">
			   ...
			   <form id="userModalForm" method="POST" action="<?php echo e(route('users.store')); ?>" class="uv-modal-form">
				   <?php echo csrf_field(); ?>
						   ...
						   <div class="facility-checkbox-grid facility-checkbox-scroll" id="facilityCheckboxList">
							   <?php $__currentLoopData = ($facilities ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								   <label class="facility-checkbox-item">
									   <input type="checkbox" name="facility_id[]" value="<?php echo e($facility->id); ?>">
	   ...
	   .uv-btn-submit {
		   ...
		   border: none;
		   border-radius: 8px;
		   box-shadow: 0 2px 6px rgba(55,98,200,0.07);
...
<?php echo $__env->make('layouts.qc-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Lgu1-energy\resources\views/modules/users/index.blade.php ENDPATH**/ ?>