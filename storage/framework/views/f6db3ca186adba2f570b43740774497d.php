...
<div style="max-width:1200px;margin:0 auto;">
	...
	<div style="margin-bottom:24px;">
		...
		<div style="margin-top:8px;font-size:1rem;color:#888;">
			<span>👥 Total Users: <?php echo e($totalUsers ?? '-'); ?></span> |
			<span>🟢 Active Users: <?php echo e($activeUsers ?? '-'); ?></span>
		</div>
	</div>
	<!-- 2️⃣ SUMMARY CARDS -->
	<div class="row" style="display:flex;gap:24px;flex-wrap:wrap;margin-bottom:2rem;">
		<div class="card" style="flex:1 1 220px;min-width:220px;background:#f5f8ff;padding:24px 18px;border-radius:14px;box-shadow:0 2px 8px rgba(55,98,200,0.08);">
			...
			<div style="font-size:2rem;font-weight:700;margin:8px 0;"><?php echo e($totalUsers ?? '-'); ?></div>
		</div>
		<div class="card" style="flex:1 1 220px;min-width:220px;background:#f0fdf4;padding:24px 18px;border-radius:14px;box-shadow:0 2px 8px rgba(34,197,94,0.08);">
			...
			<div style="font-size:2rem;font-weight:700;margin:8px 0;"><?php echo e($activeUsers ?? '-'); ?></div>
		</div>
		...
		<div class="card" style="flex:1 1 220px;min-width:220px;background:#fff0f3;padding:24px 18px;border-radius:14px;box-shadow:0 2px 8px rgba(225,29,72,0.08);">
			...
			<div style="font-size:2rem;font-weight:700;margin:8px 0;"><?php echo e($inactiveUsers ?? '-'); ?></div>
		</div>
	</div>
	<!-- 4️⃣ ACTION BUTTONS -->
		...
		<table class="table" style="width:100%;background:#fff;border-radius:10px;overflow:hidden;text-align:center;">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php echo e($user->facility->name ?? ($user->facility_id ? ('Facility #' . $user->facility_id) : '-')); ?>
...
<div class="modal-sheet" id="userModalSheet" aria-hidden="true">
	<div class="modal-card" role="dialog" aria-modal="true">
		...
		<form id="userModalForm" method="POST" action="<?php echo e(route('users.store')); ?>">
			<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.qc-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lgu-energy\resources\views/modules/users/index.blade.php ENDPATH**/ ?>