    ...
    <div class="energy-report-shell">
        <div class="energy-header">
            ...
            <div class="energy-actions">
                <a href="<?php echo e(route('reports.energy-export', request()->all())); ?>" class="btn-action btn-excel">
                    <i class="fa fa-download"></i> Export Excel
                </a>
                <a href="<?php echo e(route('modules.energy.export-pdf', array_filter(request()->all()))); ?>" class="btn-action btn-pdf">
        ...
        <div class="energy-kpis">
            <div class="kpi-card kpi-total">
                ...
                <div class="kpi-value"><?php echo e($rows->count()); ?></div>
            </div>
            <div class="kpi-card kpi-actual">
                <span class="kpi-label">Total Actual</span>
                <div class="kpi-value"><?php echo e(number_format($totalActual, 2)); ?></div>
            </div>
            <div class="kpi-card kpi-baseline">
                <span class="kpi-label">Total Baseline</span>
                <div class="kpi-value"><?php echo e(number_format($totalBaseline, 2)); ?></div>
            </div>
            <div class="kpi-card kpi-var">
                <span class="kpi-label">Total Variance</span>
                <div class="kpi-value"><?php echo e(number_format($totalVariance, 2)); ?></div>
            </div>
            <div class="kpi-card kpi-trend">
                <span class="kpi-label">Trend (Up/Down)</span>
                <div class="kpi-value"><?php echo e($increasingCount); ?>/<?php echo e($decreasingCount); ?></div>
            </div>
        </div>
            ...
            <div class="filter-group">
                ...
                <select name="facility_id" id="facility_id">
                    ...
                    <?php $__currentLoopData = $facilities ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($facility->id); ?>" <?php echo e((request('facility_id') == $facility->id) ? 'selected' : ''); ?>>
            ...
            <table class="energy-table" id="energyTable">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $energyRows ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <tr class="energy-row" data-search="<?php echo e(strtolower((string)($row['facility'] ?? ''))); ?>">
                            <td>
                            ...
                            <td class="num"><?php echo e($row['actual_kwh']); ?></td>
                            <td class="num"><?php echo e($row['baseline_kwh']); ?></td>
                            <td class="num"><?php echo e($row['variance']); ?></td>
                            <td>
                                <span class="trend-pill <?php echo e($trendClass); ?>">
                                    <i class="fa <?php echo e($trendIcon); ?>"></i> <?php echo e($trendLabel); ?>
...
<?php echo $__env->make('layouts.qc-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Lgu1-energy\resources\views/modules/reports/energy.blade.php ENDPATH**/ ?>