		...
		<form method="POST" style="display:flex;flex-direction:column;gap:18px;">
			...
			<div style="display:flex;gap:14px;">
				...
				<div style="flex:1;">
                    ...
                    <input type="number" name="baseline_kwh" value="<?php echo e(isset($avgKwh) ? number_format($avgKwh, 2, '.', '') : ''); ?>" readonly style="width:100%;padding:9px 12px;border-radius:8px;border:1px solid #d1d5db;background:#f8fafc;">
                    <?php if(empty($avgKwh)): ?>
