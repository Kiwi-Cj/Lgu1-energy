...
<div class="container" style="padding:2.5rem 0;max-width:900px;">
    ...
    <div style="background:linear-gradient(120deg,#f5f8ff 60%,#e0e7ff 100%);border-radius:20px;padding:2.5rem 2rem 2rem 2rem;box-shadow:0 8px 32px rgba(55,98,200,0.10);">
        <!-- Filters -->
        <form method="GET" action="<?php echo e(url('/modules/energy/export-excel')); ?>">
            <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:2rem;align-items:end;">
                ...
                <div>
                    ...
                    <select name="facility_id" class="form-control" style="border-radius:8px;border:1.5px solid #c7d2fe;padding:10px 14px;font-size:1.05rem;">
                        ...
                        <?php if(isset($facilities) && count($facilities)): ?>
            ...
            <div style="margin-top:2.5rem;display:flex;gap:1.2rem;flex-wrap:wrap;align-items:center;">
                ...
                <a href="<?php echo e(url('/modules/energy/export-csv')); ?>" class="btn btn-outline-secondary" style="padding:14px 32px;font-size:1.13rem;font-weight:700;letter-spacing:0.5px;border-radius:10px;display:flex;align-items:center;gap:0.7rem;">
...
<?php echo $__env->make('layouts.qc-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\energy-system\resources\views/modules/energy/export-report.blade.php ENDPATH**/ ?>