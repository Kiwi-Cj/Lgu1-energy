...
<div class="wrapper">
    <div class="card">  
        ...
        <img src="<?php echo e(asset('img/logocityhall.jpg')); ?>" class="icon-top" style="border-radius:50%;box-shadow:0 2px 8px rgba(49,46,129,0.10);width:110px;height:110px;object-fit:cover;">
        ...
        <form id="loginForm" method="POST" action="<?php echo e(url('/login')); ?>" autocomplete="off" autocapitalize="off" spellcheck="false">
