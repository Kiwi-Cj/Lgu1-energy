...
<div class="report-card">
    ...
    <form method="GET" action="" class="filter-section">
        ...
        <a href="<?php echo e(route('modules.maintenance.index')); ?>" class="btn-filter" style="background:#fff;color:#334155;border:1px solid #cbd5e1;text-decoration:none;">Reset</a>
    </form>
    ...
    <div class="table-toolbar">
        ...
        >
        <div class="result-count">Visible rows: <span id="maintenanceVisibleCount"><?php echo e(count($maintenanceRows ?? [])); ?></span></div>
    </div>
        ...
        <table class="maint-table">
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($row['id'] ?? $i); ?>"
                    data-trigger_month="<?php echo e($row['trigger_month'] ?? ''); ?>"
                    ...
                    <td style="color:#64748b;">
                        <div class="remarks-cell" title="<?php echo e($row['remarks'] ?? '-'); ?>"><?php echo e(\Illuminate\Support\Str::limit((string) ($row['remarks'] ?? '-'), 95)); ?></div>
                    </td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (scheduleForm) {
        scheduleForm.onsubmit = async function(e) {
            ...
            try {
                const response = await fetch("<?php echo e(route('modules.maintenance.schedule')); ?>", {
                    method: 'POST',
...
<?php echo $__env->make('layouts.qc-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Lgu1-energy\resources\views/modules/maintenance/index.blade.php ENDPATH**/ ?>