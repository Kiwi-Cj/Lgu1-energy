...
<?php $__env->startSection('title', 'Log Energy Incident'); ?>
...
<div style="max-width:960px;margin:40px auto;padding:0 12px;">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:32px;">
        <div style="display:flex;align-items:center;gap:12px;">
            <a href="<?php echo e(route('energy-incidents.index')); ?>" style="color:#2563eb;font-size:1.5rem;text-decoration:none;">&#8592;</a>
            <h1 style="font-size:2rem;font-weight:700;color:#111827;margin:0;">Log Energy Incident</h1>
        </div>
    </div>

    
    <form method="POST" action="<?php echo e(route('energy-incidents.store')); ?>" enctype="multipart/form-data" style="display:flex;flex-direction:column;gap:32px;background:#fff;border-radius:18px;box-shadow:0 4px 32px rgba(55,98,200,0.10);padding:36px 32px 28px 32px;">
        <?php echo csrf_field(); ?>
