...
<div style="max-width:900px;margin:40px auto 60px;">
    ...
    <section style="margin-bottom:40px;">
        ...
        <div style="background:#fff;border-radius:14px;box-shadow:0 2px 8px #3762c80d;padding:28px 24px 18px 24px;display:grid;grid-template-columns:repeat(2,1fr);gap:18px 14px;align-items:center;">
            ...
            <div><i class="fa fa-file-invoice" style="color:#3762c8;margin-right:8px;"></i><?php echo e(auth()->user()->can_view_billing ? '✔' : '✖'); ?> View Billing</div>
...
<?php echo $__env->make('layouts.qc-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\energy-system\resources\views/profile/show.blade.php ENDPATH**/ ?>