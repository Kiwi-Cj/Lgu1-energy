...
-- Database: ener_lgu
-- Generated at: 2026-06-28 00:47:38

CREATE DATABASE IF NOT EXISTS `ener_lgu` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `ener_lgu`;
...
CREATE TABLE `audit_logs` (
  ...
  KEY `audit_logs_role_index` (`role`),
...
CREATE TABLE `main_meter_readings` (
  ...
  `input_source` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
  ...
  KEY `main_meter_readings_input_source_index` (`input_source`),
  KEY `main_meter_readings_device_id_index` (`device_id`),
...
CREATE TABLE `notifications` (
  ...
  KEY `notifications_user_read_at_idx` (`user_id`,`read_at`),
...
CREATE TABLE `submeter_baselines` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `submeter_id` bigint unsigned NOT NULL,
  `baseline_type` enum('moving_avg_3','moving_avg_6','seasonal_month','normalized_per_sqm','normalized_per_day','equipment_estimate') COLLATE utf8mb4_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS `submeter_equipment_files`;
CREATE TABLE `submeter_equipment_files` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `submeter_equipment_id` bigint unsigned NOT NULL,
  `meter_scope` enum('sub','main') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sub',
  `submeter_id` bigint unsigned DEFAULT NULL,
  `facility_meter_id` bigint unsigned DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `submeter_equipment_files_submeter_equipment_id_foreign` (`submeter_equipment_id`),
  KEY `submeter_equipment_files_submeter_id_foreign` (`submeter_id`),
  KEY `submeter_equipment_files_facility_meter_id_foreign` (`facility_meter_id`),
  KEY `submeter_equipment_files_uploaded_by_foreign` (`uploaded_by`),
  KEY `submeter_equipment_file_sub_idx` (`meter_scope`,`submeter_id`),
  KEY `submeter_equipment_file_main_idx` (`meter_scope`,`facility_meter_id`),
  CONSTRAINT `submeter_equipment_files_facility_meter_id_foreign` FOREIGN KEY (`facility_meter_id`) REFERENCES `facility_meters` (`id`) ON DELETE SET NULL,
  CONSTRAINT `submeter_equipment_files_submeter_equipment_id_foreign` FOREIGN KEY (`submeter_equipment_id`) REFERENCES `submeter_equipments` (`id`) ON DELETE CASCADE,
  CONSTRAINT `submeter_equipment_files_submeter_id_foreign` FOREIGN KEY (`submeter_id`) REFERENCES `submeters` (`id`) ON DELETE SET NULL,
  CONSTRAINT `submeter_equipment_files_uploaded_by_foreign` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `submeter_equipments` (
  ...
  KEY `submeter_equipment_main_meter_idx` (`facility_meter_id`),
  CONSTRAINT `submeter_equipments_facility_meter_id_foreign` FOREIGN KEY (`facility_meter_id`) REFERENCES `facility_meters` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `submeter_readings` (
  ...
  KEY `submeter_readings_input_source_index` (`input_source`),
  KEY `submeter_readings_device_id_index` (`device_id`),
...
INSERT INTO `users` (`facility_id`, `full_name`, `email`, `profile_photo_path`, `username`, `password`, `role`, `status`, `contact_number`, `department`, `last_login`, `created_at`, `updated_at`) VALUES
(NULL, 'Super Admin', 'cjpogi294@gmail.com', NULL, 'admin', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC.2YtZ2m26EmnlxksDmJAKOqBfO', 'super admin', 'active', '09123456789', 'Admin', NULL, NOW(), NOW());
