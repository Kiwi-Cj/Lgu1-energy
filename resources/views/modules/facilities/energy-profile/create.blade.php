...
@section('title', 'Add Energy Profile')
@section('content')
<div class="facility-create-wrapper" style="display:flex;justify-content:center;align-items:center;min-height:70vh;width:100%;">
    <div style="width:100%;max-width:520px;background:#fff;padding:38px 28px 32px 28px;border-radius:18px;box-shadow:0 8px 32px rgba(31,38,135,0.13);">
        ...
        <form action="{{ route('modules.facilities.energy-profile.store', $facilityModel->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="display:flex;justify-content:flex-end;gap:12px;">
                <a href="{{ url('/modules/facilities/' . ($facilityModel->id ?? $facility->id ?? '') . '/energy-profile') }}" style="background:#f3f4f6;color:#222;font-weight:500;border:none;border-radius:8px;padding:10px 22px;text-decoration:none;">Cancel</a>
