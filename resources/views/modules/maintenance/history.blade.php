                ...
                <table class="table table-bordered table-hover" style="background:#fff;border-radius:12px;overflow:hidden;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"><span style="font-weight:600;color:#2563eb;">{{ $row['facility'] }}</span></td>
                            <td style="text-align:center;"><span style="color:#e11d48;font-weight:500;">{{ $row['issue_type'] }}</span></td>
                            <td style="text-align:center;">{{ $row['trigger_month'] }}</td>
                            <td style="text-align:center;">
                                @if($row['efficiency_rating'] === 'High')
                                    <span style="background:#bbf7d0;color:#15803d;padding:3px 10px;border-radius:8px;font-weight:600;">High</span>
                                @elseif($row['efficiency_rating'] === 'Medium')
                            ...
                            <td style="text-align:center;">{{ $row['trend'] }}</td>
                            <td style="text-align:center;">{{ $row['maintenance_type'] }}</td>
                            <td style="text-align:center;">
                                <span style="background:#e0f7fa;color:#0097a7;padding:3px 10px;border-radius:8px;font-weight:600;">{{ $row['maintenance_status'] }}</span>
                            </td>
                            <td style="text-align:center;">{{ $row['scheduled_date'] }}</td>
                            <td style="text-align:center;">{{ $row['assigned_to'] }}</td>
                            <td style="text-align:center;"><span style="color:#22c55e;font-weight:600;">{{ $row['completed_date'] }}</span></td>
